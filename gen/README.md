...
PROJECT_SNCF API
- API version: 1.0.0
  - Build date: 2024-01-07T16:13:52.395768400+01:00[Europe/Paris]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**isTicketValid**](docs/DefaultApi.md#isTicketValid) | **POST** /ticket/validity | POST ticket/validity


## Documentation for Models

 - [TicketValidationDataDTO](docs/TicketValidationDataDTO.md)
