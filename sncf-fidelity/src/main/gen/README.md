...
Fidelite API
- API version: 1.0.0
  - Build date: 2024-01-07T15:37:28.262488100+01:00[Europe/Paris]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**fideliteVerifyClientStatusPost**](docs/DefaultApi.md#fideliteVerifyClientStatusPost) | **POST** /fidelite/verifyClientStatus | Vérifie le statut du client
