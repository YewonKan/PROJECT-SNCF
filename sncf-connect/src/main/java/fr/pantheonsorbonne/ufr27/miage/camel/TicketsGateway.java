...
public class TicketsGateway {
    ...
    @Handler
    void emitTicket(int idTrip, String fname, String lname, String email, String phone) throws CustomersNotFoundException, TripNotFoundException, NoAvailablePlaces {
        try {
